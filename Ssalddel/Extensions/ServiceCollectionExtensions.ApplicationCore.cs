...
public static partial class ServiceCollectionExtensions
{
    public static IServiceCollection AddSsalddelApplicationCore(this IServiceCollection services)
    {
        ...
        services.AddScoped<I운영후속처리복구UseCase, 운영후속처리복구UseCase>();
        services.AddScoped<I음식배달중단검토UseCase, 음식배달중단검토UseCase>();
        services.AddScoped<I비정상운송사건운영UseCase, 비정상운송사건운영UseCase>();
        ...
        services.AddSingleton<I지역이동망GraphSource, LocalPrivate지역이동망GraphSource>();
        services.AddScoped<I지역이동망조회UseCase, 지역이동망조회UseCase>();
        services.AddSingleton<I역세권디오라마Catalog, 역세권디오라마Catalog>();
