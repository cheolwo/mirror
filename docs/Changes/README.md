...
| 날짜 | 기록 | 주요 화면 변화 |
| --- | --- | --- |
| 2026-09-12 | [사가정 주소·높이 Game View 재검증](2026-09-12-sagajeong-address-gameview.md) | 도로명/주소 마지막 페이지/확대·이동·귀환 합성 GUI 입력, 후보 높이2건 실행 Mesh·화면 확인. 72/72, 업무0건·기존 서버 오류는 별도. 로컬 커밋 완료·push 안 함 |
| 2026-09-12 | [사가정역 방어 준비·옥상 배치](2026-09-12-station-defense-preparation.md) | 실제 준비·배치·재배치 화면 확인. 운영 표시 분리, 가상 인원 1명. API 전환 검증/실제 클릭 미검증, 전투 제외. 로컬 커밋 완료·push 안 함 |
| 2026-09-12 | [사가정역 생활 디오라마](2026-09-12-sagajeong-diorama.md) | 실제 동결 지도·가상 업무 6건·전체/선택/귀환 카메라 확인. Unity 41/41·공유 779/779, 이동·실운영·시각 마감 제외. 커밋 전 |
