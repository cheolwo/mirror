...
| `PLAN-SYSTEM-OBSERVABLE-OPERATIONS-DIORAMA-001` | [관찰 가능한 운영 디오라마 r2](Planning/시스템/PLAN-SYSTEM-OBSERVABLE-OPERATIONS-DIORAMA-001/README.md) · [E7 수직 작업 명세 r2](Planning/시스템/PLAN-SYSTEM-OBSERVABLE-OPERATIONS-DIORAMA-001/implementation.r2.md) | `Approved / ImplementationAuthorized / SampleOperationsOnly / OperationalEffectsDisabled` | 음식·화물·창고/마트의 정상·회복 여섯 합성 업무를 전용 MySQL/MongoDB/Redis에서 10분간 결정적으로 실행하고 v2 상태 사본으로 관찰한다. Unity는 canonical Scene의 휘발성 읽기 전용 표현만 담당한다. |
