...
| `PLAN-SYSTEM-ADMIN-DONG-DIORAMA` | [행정동별 서버 기반 디오라마 r2](Planning/시스템/PLAN-SYSTEM-ADMIN-DONG-DIORAMA/README.md) | `Approved / ActualAdministrativeDongDataGateClosed / ServerProjectionFoundationImplemented / UnityReadOnlyAdapterImplemented / SponsorshipLedgerFoundationImplemented / SceneApplicationDeferred` | 기능 생활권보다 먼저 공식 6개 행정동 경계로 면목동 건물 602개를 전수 귀속하고 면목제3·8동 건물 250개·도로 722개 선분을 Mongo 불변 판본으로 게시·독립 재조회했다. 상권 관측 5,411건은 행정동 분석만 하고 승인 표식은 0건으로 유지한다. Unity Scene·결제는 후속이다. |
